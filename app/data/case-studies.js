...
export const caseStudies = [
    ...
    excerpt: [
      {
        ...
        tooltip: {
          ...
          paragraphs: [
            'I worked at Freedom Forever (one of the largest residential solar installers in the U.S.) from 2021 to 2026.  Due to new law passed in 2025 that removed tax incentives for residential solar, cascading bankruptcies in the solar industry ultimately claimed Freedom Forever and my time there abruptly ended when the company filed for bankruptcy in April of 2026.',
            'Prior to the bankruptcy, the software team kicked into high gear to compensate for cash flow crunches and reduced staff. These financial challenges accelerated AI adoption. Lead by our VP of Product and Engineering, I received a master class and crash course in utilizing AI tools and best practices alongside my fellow product and developer colleagues.',
            'Volt is Freedom Forever’s lead and project management app designed and built for solar sales teams. I was the lead designer on Volt from day one — and while I did more than work on this app over my time at Freedom Forever, Volt is where I spent the most of my time and energy',
          ],
        },
      },
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        tags: [],
        left: [
          "First I went through our full onboarding flow the way a rep would—hitting the required online training and going through the full set of lessons. As I went, I opened a Claude chat in Slack and used an AI it as a running notepad, recording my observations via AI transcription as they came to me rather than trying to hold everything in my head or pausing to type my full thoughts.",
...

  {
    ...
    imageOffset: 20,
    introImage: null,
    subtitle: "A gamification system for sales reps, grounded in how motivation actually works",
    role: 'Lead designer',
    scope: 'Feature design, gamification system, leaderboards, competitions',
    sections: [
      {
        id: 'exploration',
